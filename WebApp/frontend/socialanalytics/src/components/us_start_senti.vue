    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body" style="height:400px">
                    <div class="chart-area">
                        <img src="../assets/negative_wordcloud_start_us.png" height="300px" style="margin:0 auto; display: block;">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-lg-7" >
            <div class="card shadow mb-4">
                ...
                <div class="card-body" style="height:400px">
                    <div class="chart-area">
                        <img src="../assets/neutral_wordcloud_start_us.png" height="300px" style="margin:0 auto; display: block;">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body" style="height:400px">
                    <div class="chart-area">
                        ...
                        <img src="../assets/positive_wordcloud_start_us.png" height="300px" style="margin:0 auto; display: block;">
                ...
                <div class="card-body" style="height:300px">
                    <div class="chart-area">
                        <p>
                            ...
                            <br/>
                            Positive tweets are the highest in proportion at 41%, followed by negative tweets at 34%, and neutral tweets at 25%. This indicated that the community was generally optimistic about tackling COVID-19 but there were those that were concerned about it and unemployment. Examples included “Hopefully, this new test for Covid 19 is successful and accurate. We will know soon. "FDA approves new test that could detect coronavirus in about 45 minutes". #CoronavirusPandemic #Covid_19 #testkits #Medical #hope #StayAtHome” and “This is one of the dumbest things I've read in a long time. To waste so much time and resources trying to put this together while thousands of americans die every day to coronavirus and millions go unemployed is horrifying.”. 
                            <br/>
                            <strong>*Line Chart</strong>
                            <br/>
                            Tweet counts peaked when the lockdown was announced in March 2020 . 
                            <br/>
                            <strong>*Word Cloud</strong>
                            <br/>
                            It is also very likely that Trump (and the US) was blaming China for the pandemic with words such as “president”, “realdonaldtrump”, and “china” appearing frequently. 
...
export default {
    ...
    data(){
        return{
            bar_start:[{"name":'Sentiment',"data":[35,26,39]}],
            lineData:[
                {
                    "name":"Positive",
                    "data": [1,28,64,50,39,45,371,572,1836,1462]
                },
                {
                    "name":"Neutral",
                    "data": [1,51,68,30,24,37,281,449,1228,823]
                },
                {
                    "name":"Negative",
                    "data": [1,1,34,99,62,49,107,469,606,1427]
                }
            ],
            lineChartOptions: {
                chart: {
                ...
                xaxis: {
                    categories: ["2020-01-20","2020-01-27","2020-02-03","2020-02-10","2020-02-17","2020-02-24","2020-03-02","2020-03-09","2020-03-16","2020-03-23"],
                    title: {
                        text: 'Date'
                    }
                },
    ...
    // async mounted(){
    //     await axios.get("http://127.0.0.1:5000/getSentimentAnalysisStartUS")
    //         .then(res=>{
